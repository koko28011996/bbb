...
<h2 class="w3ls">Đăng Ký thành viên tại đây</h2>
	...
	<div class="content-agile2">
		<form action="index.php?act=dangky" method="post" enctype="multipart/form-data">
			<div class="formad w3layouts"> 
				<input type="text" id="firstname" class="inputad" id="user" name="user" placeholder="Vui lòng nhập tên" title="Vui lòng nhập tên" required="">
			...
			<div class="formad w3layouts">	
				<input type="email" id="email" name="email" class="inputad" id="email"  placeholder="Vui lòng nhập email" title="Vui lòng nhập email" required="">
			</div>
			<div class="formad w3layouts"> 
				<input type="text" id="firstname" class="inputad"  name="dress" id="dress" placeholder="Vui lòng nhập địa chỉ" title="Vui lòng nhập địa chỉ" required="">
			</div>
			<div class="formad w3layouts"> 
				<input type="text" id="firstname" class="inputad" name="phone" placeholder="Vui lòng nhập số điện thoại" title="Vui lòng nhập số điện thoại" required="">
			</div>
